...
class QuestionTooLongError(PgMcpError):
    """Exception raised when the natural-language question exceeds the configured limit."""

    def __init__(self, message: str, details: dict[str, Any] | None = None) -> None:
        """Initialize question-too-long error.

        Args:
            message: Error message describing the length violation.
            details: Optional details such as the actual and maximum lengths.
        """
